...
class WhichBarcodeInspectWindow():
    ...
    def __init__(self, barcode_1, barcode_2, figsize=(6, 4), dpi=100, window_theme=None, window_color=None):
        """
        Initialize
        ...
        self.button_inspect = ttk.Button(master=self.window, text="Inspect", command=self.inspect_barcode)
